...
### RUN WITH THIS COMMAND FROM DESKTOP (PARENT DIRECTORY OF SOC_IMPLEMENTATION_NDMD) python -m SoC-estimation-using-NDMD.soc_matlab_implementation.main
...
if __name__ == '__main__':
    ...
    '''
    exp = 'soc'
    project_dir = './SOC-estimation-using-NDMD/soc_matlab_implementation/'
    test_dir_name = project_dir + "csv_battery_dataset/"
    train_file_name = project_dir + "csv_battery_dataset/train_dataset.csv"
    ...
    test_files = ['test_0C.csv', 'test_10C.csv', 'test_25C.csv', 'test_neg10C.csv']
