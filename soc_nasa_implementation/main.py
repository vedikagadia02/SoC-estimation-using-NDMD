...
# RUN WITH THIS COMMAND FROM DESKTOP (PARENT DIRECTORY OF SOC_IMPLEMENTATION_NDMD) python -m SoC-estimation-using-NDMD.soc_nasa_implementation.main
...
if __name__ == '__main__':
    ...
    CHANGE VALUES HERE
    '''
    file_name = "./SOC-estimation-using-NDMD/soc_nasa_implementation/dataset/soc_dataset_7.npy"
    model_dir = "./SOC-estimation-using-NDMD/soc_nasa_implementation/checkpoints"
    koopman_dir = "./SOC-estimation-using-NDMD/soc_nasa_implementation/KoopmanPerEpoch"
    plot_dir = "./SOC-estimation-using-NDMD/soc_nasa_implementation/plots/test"
    ntrain = 126
    ntest = 42
    train_batch_size = 64
    test_batch_size = 16
